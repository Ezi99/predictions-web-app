...
import admin.ui.management.header.HeaderController;
import admin.ui.tasks.management.SimulationListRefresher;
import admin.utils.Constants;
import admin.utils.http.HttpClientUtil;
import com.google.gson.Gson;
import dto.definition.*;
import dto.definition.action.*;
...
public class ManagementController implements Closeable {
    ...
    public void setBaseController(BaseController baseController) {
        ...
        headerComponentController.setBaseController(baseController);
    }
    ...
    public void bindFileStatus(ReadOnlyStringProperty readOnlyStringProperty, ReadOnlyObjectProperty<Throwable> throwableReadOnlyObjectProperty) {
        headerComponentController.bindFileStatus(readOnlyStringProperty, throwableReadOnlyObjectProperty);
    }
        ...
        HttpClientUtil.runAsync(finalUrl, new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                Platform.runLater(() -> {
                    ...
                    headerComponentController.printErrorMessage(message);
                });
            }
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                    ...
                    Platform.runLater(() -> {
                        ...
                        headerComponentController.printErrorMessage("");
                    });
                } else {
                    Platform.runLater(() ->
                            headerComponentController.printErrorMessage(bodyString));
                }
            }
        });
    }
    ...
    private void startSimulationListRefresher() {
